...
import { EMPRESA, INSTAGRAM_LINK, WHATSAPP_LINK } from "@/lib/constants";
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  ...
                  >
                    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#262626] group-hover:bg-[#333333] transition-colors">
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs uppercase tracking-wider text-white/40 mb-0.5">Instagram</p>
                      <p>{EMPRESA.contato.instagram}</p>
                    </div>
                  </a>
                </li>
                <li>
